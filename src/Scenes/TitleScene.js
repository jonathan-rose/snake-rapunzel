...
export default class TitleScene extends Phaser.Scene {
	...
	create () {
        ...
        this.gameButton = new Button(this, config.width*0.5, config.height/2 + 60, 'playBtn', 'playBtnPressed', '', 'Game');

        // Options
        this.optionsButton = new Button(this, config.width*0.5, config.height/2 + 170, 'optionsBtn', 'optionsBtnPressed', '', 'Options');

        // About
        this.aboutButton = new Button(this, config.width*0.5, config.height/2 + 280, 'creditsBtn', 'creditsBtnPressed', '', 'About');
